...
def create_settings():
    """
    Creates a new wlan_simulation_game_settings.py file in the base
    directory if inexistent.
    """
    base_dir = os.path.dirname(__file__)
    if not os.path.exists(os.path.join(base_dir, 'wlan_simulation_game_settings.py')):
        ...
        with open(default_settings_path) as default_settings:
            ...
            with open(os.path.join(base_dir, 'wlan_simulation_game_settings.py'), 'w') as new_settings:
